...
{
    [JsonPropertyName("image_tokens")] public int? ImageTokens { get; set; }
...
public record ThorUsageResponseCompletionTokensDetails
{
    ...
    /// <summary>
    ///     使用 Predicted Outputs 时， 预测，但未出现在 completion 中。但是，与 reasoning 令牌，这些令牌仍然计入总数 用于 Billing、Output 和 Context Window 的完成令牌
    ///     限制。
    /// </summary>
